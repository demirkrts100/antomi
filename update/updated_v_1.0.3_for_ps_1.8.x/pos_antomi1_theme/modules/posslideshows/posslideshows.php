        ...
        for ($i = 1; $i <= 3; ++$i) {
            ...
            foreach ($languages as $language) {
				...
				if($i==1){
					...
					$slide->description[$language['id_lang']] = '{"1":{"title":"Popular products","display":"3","animation":"12"},"2":{"title":"Summer","display":"0","animation":"12"},"3":{"title":"Collection 2019","display":"0","animation":"12"},"4":{"title":"Discount -30% Off This Week","display":"4","animation":"12"},"5":{"title":"discover Now","display":"5","animation":"12"}}';
				}elseif($i==2){
					$slide->title = 'slide show2';
					$slide->cap_position = 1;
					$slide->description[$language['id_lang']] = '{"1":{"title":"New arrivals","display":"3","animation":"13"},"2":{"title":"Business","display":"0","animation":"13"},"3":{"title":"Of Mobile Apps","display":"0","animation":"13"},"4":{"title":"Discount -10% Off This Week","display":"4","animation":"13"},"5":{"title":"discover Now","display":"5","animation":"13"}}';
				}elseif($i==3){
					$slide->title = 'slide show3';
					$slide->cap_position = 1;
					$slide->description[$language['id_lang']] = '{"1":{"title":"New arrivals","display":"3","animation":"14"},"2":{"title":"Cellphone","display":"0","animation":"14"},"3":{"title":"Galaxy S9 | S9+","display":"0","animation":"14"},"4":{"title":"Discount -60% Off This Week","display":"4","animation":"14"},"5":{"title":"discover Now","display":"5","animation":"14"}}';
				}else{
